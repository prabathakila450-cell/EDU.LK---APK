...
object ShortAnswerGrade10Data {
  ...
  val sets = listOf(
    QuestionSetInfo(11, "10", "කාණ්ඩය 11: විද්‍යාව - රසායනික බන්ධන සහ මවුලය", "විද්‍යාව", "⚗️"),
    QuestionSetInfo(12, "10", "කාණ්ඩය 12: විද්‍යාව - පටක, ආහාර ජීර්ණය සහ ශ්වසනය", "විද්‍යාව", "🫀"),
    QuestionSetInfo(13, "10", "කාණ්ඩය 13: විද්‍යාව - චලිත සමීකරණ සහ නිව්ටන් නියම", "විද්‍යාව", "🚀"),
    QuestionSetInfo(14, "10", "කාණ්ඩය 14: ගණිතය - වර්ගජ ප්‍රකාශන සහ සාධක", "ගණිතය", "🔢"),
    QuestionSetInfo(15, "10", "කාණ්ඩය 15: ගණිතය - ත්‍රිකෝණමිතිය සහ පරිමාව", "ගණිතය", "📐"),
    QuestionSetInfo(16, "10", "කාණ්ඩය 16: ඉතිහාසය - පොළොන්නරු යුගය සහ රජවරු", "ඉතිහාසය", "👑"),
    QuestionSetInfo(17, "10", "කාණ්ඩය 17: ඉතිහාසය - මධ්‍යකාලීන රාජධානි සහ කෝට්ටේ", "ඉතිහාසය", "🏰"),
    QuestionSetInfo(18, "10", "කාණ්ඩය 18: බුද්ධ ධර්මය - චතුරාර්ය සත්‍යය සහ කර්මය", "බුද්ධ ධර්මය", "🪷"),
    QuestionSetInfo(19, "10", "කාණ්ඩය 19: සිංහල - වියත් වහර, නිවැරදි ව්‍යාකරණ", "සිංහල", "📜"),
    QuestionSetInfo(20, "10", "කාණ්ඩය 20: ICT - තර්ක ද්වාර සහ දත්ත සන්නිවේදනය", "ICT", "🔌")
  )

  val questions = listOf(
    // -------------------------------------------------------------------------
    // SET 11: විද්‍යාව - රසායනික බන්ධන සහ මවුලය (Grade 10)
    // -------------------------------------------------------------------------
    ShortAnswerQuestion(
      id = 201,
      grade = "10",
    ...
    // -------------------------------------------------------------------------
    // SET 12: විද්‍යාව - පටක, ආහාර ජීර්ණය සහ ශ්වසනය (Grade 10)
    // -------------------------------------------------------------------------
    ShortAnswerQuestion(
      id = 211,
      grade = "10",
    ...
    // -------------------------------------------------------------------------
    // SET 13: විද්‍යාව - චලිත සමීකරණ සහ නිව්ටන් නියම (Grade 10)
    // -------------------------------------------------------------------------
    ShortAnswerQuestion(
      id = 221,
      grade = "10",
    ...
    // -------------------------------------------------------------------------
    // SET 14: ගණිතය - වර්ගජ ප්‍රකාශන සහ සාධක (Grade 10)
    // -------------------------------------------------------------------------
    ShortAnswerQuestion(
      id = 231,
      grade = "10",
    ...
    // -------------------------------------------------------------------------
    // SET 15: ගණිතය - ත්‍රිකෝණමිතිය සහ පරිමාව (Grade 10)
    // -------------------------------------------------------------------------
    ShortAnswerQuestion(
      id = 241,
      grade = "10",
    ...
    // -------------------------------------------------------------------------
    // SET 16: ඉතිහාසය - පොළොන්නරු යුගය සහ රජවරු (Grade 10)
    // -------------------------------------------------------------------------
    ShortAnswerQuestion(
      id = 251,
      grade = "10",
    ...
    // -------------------------------------------------------------------------
    // SET 17: ඉතිහාසය - මධ්‍යකාලීන රාජධානි සහ කෝට්ටේ (Grade 10)
    // -------------------------------------------------------------------------
    ShortAnswerQuestion(
      id = 261,
      grade = "10",
    ...
    // -------------------------------------------------------------------------
    // SET 18: බුද්ධ ධර්මය - චතුරාර්ය සත්‍යය සහ කර්මය (Grade 10)
    // -------------------------------------------------------------------------
    ShortAnswerQuestion(
      id = 271,
      grade = "10",
    ...
    // -------------------------------------------------------------------------
    // SET 19: සිංහල - වියත් වහර, නිවැරදි ව්‍යාකරණ (Grade 10)
    // -------------------------------------------------------------------------
    ShortAnswerQuestion(
      id = 281,
      grade = "10",
    ...
    // -------------------------------------------------------------------------
    // SET 20: ICT - තර්ක ද්වාර සහ දත්ත සන්නිවේදනය (Grade 10)
    // -------------------------------------------------------------------------
    ShortAnswerQuestion(
      id = 291,
      grade = "10",
